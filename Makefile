...
install:
	...
	cp -r img/canaima-burg-icon.png $(DESTIDR)/usr/share/pixmaps/	
	...
	ln -s /usr/share/canaima-notas-gnome/scripts/canaima-mod-burg.py $(DESTDIR)/usr/bin/canaima-notas-gnome
